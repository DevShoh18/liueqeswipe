...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "assets/img.jpg", "Hi", "It's Me", "Sahdeep"),
    ItemData(Colors.deepPurpleAccent, "assets/img.jpg", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "assets/img.jpg", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "assets/img.jpg", "Can be", "Used for",
        "Onboarding design"),
    ItemData(Colors.red, "assets/img.jpg", "Do", "try it", "Thank you"),
  ];
